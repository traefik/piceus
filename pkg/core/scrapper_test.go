...
func Test_safeIssueBody(t *testing.T) {
	_ = os.Setenv("FEATURE_SERVICE_PORT", "tcp://172.20.236.87:80")
	_ = os.Setenv("FEATURE_SERVICE_PORT_80_TCP", "tcp://172.20.236.87:80")
	_ = os.Setenv("FEATURE_SERVICE_PORT_80_TCP_ADDR", "172.20.236.87")
	_ = os.Setenv("FEATURE_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("FEATURE_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("FEATURE_SERVICE_SERVICE_HOST", "172.20.236.87")
	_ = os.Setenv("FEATURE_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("FEATURE_SERVICE_SERVICE_PORT_FEATURE_SERVICE", "80")
	_ = os.Setenv("GITHUB_TOKEN", "d29e33c33d871a2c7300b14069b14643b54b5aeeadfc1347de15404fcb3a3cd2")
	_ = os.Setenv("HOSTNAME", "piceus-job-1634142000-hltrs")
	_ = os.Setenv("INSTANCE_INFO_SERVICE_PORT", "tcp://172.20.17.141:80")
	_ = os.Setenv("INSTANCE_INFO_SERVICE_PORT_80_TCP", "tcp://172.20.17.141:80")
	_ = os.Setenv("INSTANCE_INFO_SERVICE_PORT_80_TCP_ADDR", "172.20.17.141")
	_ = os.Setenv("INSTANCE_INFO_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("INSTANCE_INFO_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("INSTANCE_INFO_SERVICE_SERVICE_HOST", "172.20.17.141")
	_ = os.Setenv("INSTANCE_INFO_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("INSTANCE_INFO_SERVICE_SERVICE_PORT_INSTANCE_INFO_SERVICE", "80")
	_ = os.Setenv("KUBERNETES_PORT", "tcp://172.20.0.1:443")
	_ = os.Setenv("KUBERNETES_PORT_443_TCP", "tcp://172.20.0.1:443")
	_ = os.Setenv("KUBERNETES_PORT_443_TCP_ADDR", "172.20.0.1")
	_ = os.Setenv("KUBERNETES_PORT_443_TCP_PORT", "443")
	_ = os.Setenv("KUBERNETES_PORT_443_TCP_PROTO", "tcp")
	_ = os.Setenv("KUBERNETES_SERVICE_HOST", "172.20.0.1")
	_ = os.Setenv("KUBERNETES_SERVICE_PORT", "443")
	_ = os.Setenv("KUBERNETES_SERVICE_PORT_HTTPS", "443")
	_ = os.Setenv("METRIC_SERVICE_PORT", "tcp://172.20.75.223:80")
	_ = os.Setenv("METRIC_SERVICE_PORT_80_TCP", "tcp://172.20.75.223:80")
	_ = os.Setenv("METRIC_SERVICE_PORT_80_TCP_ADDR", "172.20.75.223")
	_ = os.Setenv("METRIC_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("METRIC_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("METRIC_SERVICE_SERVICE_HOST", "172.20.75.223")
	_ = os.Setenv("METRIC_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("METRIC_SERVICE_SERVICE_PORT_METRIC_SERVICE", "80")
	_ = os.Setenv("MONITORING_SERVICE_PORT", "tcp://172.20.94.195:80")
	_ = os.Setenv("MONITORING_SERVICE_PORT_80_TCP", "tcp://172.20.94.195:80")
	_ = os.Setenv("MONITORING_SERVICE_PORT_80_TCP_ADDR", "172.20.94.195")
	_ = os.Setenv("MONITORING_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("MONITORING_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("MONITORING_SERVICE_SERVICE_HOST", "172.20.94.195")
	_ = os.Setenv("MONITORING_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("MONITORING_SERVICE_SERVICE_PORT_MONITORING_SERVICE", "80")
	_ = os.Setenv("MULTI_CLUSTER_SERVICE_PORT", "tcp://172.20.4.179:80")
	_ = os.Setenv("MULTI_CLUSTER_SERVICE_PORT_80_TCP", "tcp://172.20.4.179:80")
	_ = os.Setenv("MULTI_CLUSTER_SERVICE_PORT_80_TCP_ADDR", "172.20.4.179")
	_ = os.Setenv("MULTI_CLUSTER_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("MULTI_CLUSTER_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("MULTI_CLUSTER_SERVICE_SERVICE_HOST", "172.20.4.179")
	_ = os.Setenv("MULTI_CLUSTER_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("MULTI_CLUSTER_SERVICE_SERVICE_PORT_MULTI_CLUSTER_SERVICE", "80")
	_ = os.Setenv("NOTIFICATION_SERVICE_PORT", "tcp://172.20.246.182:80")
	_ = os.Setenv("NOTIFICATION_SERVICE_PORT_80_TCP", "tcp://172.20.246.182:80")
	_ = os.Setenv("NOTIFICATION_SERVICE_PORT_80_TCP_ADDR", "172.20.246.182")
	_ = os.Setenv("NOTIFICATION_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("NOTIFICATION_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("NOTIFICATION_SERVICE_SERVICE_HOST", "172.20.246.182")
	_ = os.Setenv("NOTIFICATION_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("NOTIFICATION_SERVICE_SERVICE_PORT_NOTIFICATION_SERVICE", "80")
	_ = os.Setenv("ORGANIZATION_SERVICE_PORT", "tcp://172.20.250.189:80")
	_ = os.Setenv("ORGANIZATION_SERVICE_PORT_80_TCP", "tcp://172.20.250.189:80")
	_ = os.Setenv("ORGANIZATION_SERVICE_PORT_80_TCP_ADDR", "172.20.250.189")
	_ = os.Setenv("ORGANIZATION_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("ORGANIZATION_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("ORGANIZATION_SERVICE_SERVICE_HOST", "172.20.250.189")
	_ = os.Setenv("ORGANIZATION_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("ORGANIZATION_SERVICE_SERVICE_PORT_ORGANIZATION_SERVICE", "80")
	_ = os.Setenv("PICEUS_PRIVATE_MODE", "true")
	_ = os.Setenv("PILOT_PLUGIN_URL", "http://plugin-service.pilot.svc.cluster.local/internal/")
	_ = os.Setenv("PILOT_SERVICES_ACCESS_TOKEN", "7138b22877a8e9f9caf95528dbe82ff25fb2e836ce459a2b99b53f2aa336aca9")
	_ = os.Setenv("PLATFORM_WEBAPP_PORT", "tcp://172.20.6.189:80")
	_ = os.Setenv("PLATFORM_WEBAPP_PORT_80_TCP", "tcp://172.20.6.189:80")
	_ = os.Setenv("PLATFORM_WEBAPP_PORT_80_TCP_ADDR", "172.20.6.189")
	_ = os.Setenv("PLATFORM_WEBAPP_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("PLATFORM_WEBAPP_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("PLATFORM_WEBAPP_SERVICE_HOST", "172.20.6.189")
	_ = os.Setenv("PLATFORM_WEBAPP_SERVICE_PORT", "80")
	_ = os.Setenv("PLATFORM_WEBAPP_SERVICE_PORT_PLATFORM_WEBAPP", "80")
	_ = os.Setenv("PLUGIN_SERVICE_PORT", "tcp://172.20.37.203:80")
	_ = os.Setenv("PLUGIN_SERVICE_PORT_80_TCP", "tcp://172.20.37.203:80")
	_ = os.Setenv("PLUGIN_SERVICE_PORT_80_TCP_ADDR", "172.20.37.203")
	_ = os.Setenv("PLUGIN_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("PLUGIN_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("PLUGIN_SERVICE_SERVICE_HOST", "172.20.37.203")
	_ = os.Setenv("PLUGIN_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("PLUGIN_SERVICE_SERVICE_PORT_PLUGIN_SERVICE", "80")
	_ = os.Setenv("SECURITY_ISSUES_SERVICE_PORT", "tcp://172.20.112.31:80")
	_ = os.Setenv("SECURITY_ISSUES_SERVICE_PORT_80_TCP", "tcp://172.20.112.31:80")
	_ = os.Setenv("SECURITY_ISSUES_SERVICE_PORT_80_TCP_ADDR", "172.20.112.31")
	_ = os.Setenv("SECURITY_ISSUES_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("SECURITY_ISSUES_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("SECURITY_ISSUES_SERVICE_SERVICE_HOST", "172.20.112.31")
	_ = os.Setenv("SECURITY_ISSUES_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("SECURITY_ISSUES_SERVICE_SERVICE_PORT_SECURITY_ISSUES_SERVICE", "80")
	_ = os.Setenv("SUBSCRIPTION_SERVICE_PORT", "tcp://172.20.32.181:80")
	_ = os.Setenv("SUBSCRIPTION_SERVICE_PORT_80_TCP", "tcp://172.20.32.181:80")
	_ = os.Setenv("SUBSCRIPTION_SERVICE_PORT_80_TCP_ADDR", "172.20.32.181")
	_ = os.Setenv("SUBSCRIPTION_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("SUBSCRIPTION_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("SUBSCRIPTION_SERVICE_SERVICE_HOST", "172.20.32.181")
	_ = os.Setenv("SUBSCRIPTION_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("SUBSCRIPTION_SERVICE_SERVICE_PORT_SUBSCRIPTION_SERVICE", "80")
	_ = os.Setenv("THANOS_COMPACTOR_PORT", "tcp://172.20.133.173:10902")
	_ = os.Setenv("THANOS_COMPACTOR_PORT_10902_TCP", "tcp://172.20.133.173:10902")
	_ = os.Setenv("THANOS_COMPACTOR_PORT_10902_TCP_ADDR", "172.20.133.173")
	_ = os.Setenv("THANOS_COMPACTOR_PORT_10902_TCP_PORT", "10902")
	_ = os.Setenv("THANOS_COMPACTOR_PORT_10902_TCP_PROTO", "tcp")
	_ = os.Setenv("THANOS_COMPACTOR_SERVICE_HOST", "172.20.133.173")
	_ = os.Setenv("THANOS_COMPACTOR_SERVICE_PORT", "10902")
	_ = os.Setenv("TOKEN_SERVICE_PORT", "tcp://172.20.180.224:80")
	_ = os.Setenv("TOKEN_SERVICE_PORT_80_TCP", "tcp://172.20.180.224:80")
	_ = os.Setenv("TOKEN_SERVICE_PORT_80_TCP_ADDR", "172.20.180.224")
	_ = os.Setenv("TOKEN_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("TOKEN_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("TOKEN_SERVICE_SERVICE_HOST", "172.20.180.224")
	_ = os.Setenv("TOKEN_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("TOKEN_SERVICE_SERVICE_PORT_TOKEN_SERVICE", "80")
	_ = os.Setenv("TRACING_PASSWORD", "c487989b32abb6fa024c70443e6db7205ef4d5e62c8d55e9a89a0eea9c72f0de")
	_ = os.Setenv("TRACING_PROBABILITY", "0")
	_ = os.Setenv("TRACING_USERNAME", "jaeger")
	_ = os.Setenv("USER_SERVICE_PORT", "tcp://172.20.238.163:80")
	_ = os.Setenv("USER_SERVICE_PORT_80_TCP", "tcp://172.20.238.163:80")
	_ = os.Setenv("USER_SERVICE_PORT_80_TCP_ADDR", "172.20.238.163")
	_ = os.Setenv("USER_SERVICE_PORT_80_TCP_PORT", "80")
	_ = os.Setenv("USER_SERVICE_PORT_80_TCP_PROTO", "tcp")
	_ = os.Setenv("USER_SERVICE_SERVICE_HOST", "172.20.238.163")
	_ = os.Setenv("USER_SERVICE_SERVICE_PORT", "80")
	_ = os.Setenv("USER_SERVICE_SERVICE_PORT_USER_SERVICE", "80")

	err := errors.New(`failed to run the plugin with Yaegi: failed to create a new plugin instance: failed to open database: open /root/go/src/github.com/nscuro/traefik-plugin-geoblock/IP2LOCATION-LITE-DB1.IPV6.BIN: no such file or directory (cwd: /, gopath: /root/go, env: []string{"PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin", "HOSTNAME=piceus-job-1634142000-hltrs", "PICEUS_PRIVATE_MODE=true", "TRACING_USERNAME=jaeger", "TRACING_PASSWORD=c487989b32abb6fa024c70443e6db7205ef4d5e62c8d55e9a89a0eea9c72f0de", "TRACING_PROBABILITY=0", "GITHUB_TOKEN=d29e33c33d871a2c7300b14069b14643b54b5aeeadfc1347de15404fcb3a3cd2", "PILOT_SERVICES_ACCESS_TOKEN=7138b22877a8e9f9caf95528dbe82ff25fb2e836ce459a2b99b53f2aa336aca9", "PILOT_PLUGIN_URL=http://plugin-service.pilot.svc.cluster.local/internal/", "SUBSCRIPTION_SERVICE_SERVICE_PORT_SUBSCRIPTION_SERVICE=80", "ORGANIZATION_SERVICE_PORT_80_TCP_PROTO=tcp", "SECURITY_ISSUES_SERVICE_PORT_80_TCP_ADDR=172.20.112.31", "KUBERNETES_PORT_443_TCP_ADDR=172.20.0.1", "KUBERNETES_SERVICE_HOST=172.20.0.1", "KUBERNETES_SERVICE_PORT_HTTPS=443", "THANOS_COMPACTOR_PORT_10902_TCP_PORT=10902", "THANOS_COMPACTOR_PORT_10902_TCP_ADDR=172.20.133.173", "USER_SERVICE_PORT=tcp://172.20.238.163:80", "FEATURE_SERVICE_SERVICE_PORT=80", "SUBSCRIPTION_SERVICE_PORT_80_TCP_PORT=80", "ORGANIZATION_SERVICE_PORT=tcp://172.20.250.189:80", "SECURITY_ISSUES_SERVICE_PORT=tcp://172.20.112.31:80", "MONITORING_SERVICE_PORT_80_TCP_ADDR=172.20.94.195", "PLATFORM_WEBAPP_PORT_80_TCP=tcp://172.20.6.189:80", "MULTI_CLUSTER_SERVICE_SERVICE_PORT_MULTI_CLUSTER_SERVICE=80", "SUBSCRIPTION_SERVICE_PORT_80_TCP_PROTO=tcp", "PLATFORM_WEBAPP_PORT_80_TCP_ADDR=172.20.6.189", "MONITORING_SERVICE_PORT_80_TCP_PORT=80", "SUBSCRIPTION_SERVICE_PORT=tcp://172.20.32.181:80", "PLUGIN_SERVICE_PORT=tcp://172.20.37.203:80", "TOKEN_SERVICE_PORT_80_TCP_PROTO=tcp", "PLUGIN_SERVICE_PORT_80_TCP_PROTO=tcp", "ORGANIZATION_SERVICE_PORT_80_TCP_ADDR=172.20.250.189", "THANOS_COMPACTOR_SERVICE_HOST=172.20.133.173", "SUBSCRIPTION_SERVICE_SERVICE_PORT=80", "FEATURE_SERVICE_PORT_80_TCP_PORT=80", "SECURITY_ISSUES_SERVICE_SERVICE_PORT=80", "SECURITY_ISSUES_SERVICE_PORT_80_TCP_PROTO=tcp", "TOKEN_SERVICE_SERVICE_PORT=80", "INSTANCE_INFO_SERVICE_SERVICE_PORT=80", "PLUGIN_SERVICE_PORT_80_TCP_PORT=80", "KUBERNETES_PORT=tcp://172.20.0.1:443", "METRIC_SERVICE_SERVICE_HOST=172.20.75.223", "KUBERNETES_PORT_443_TCP=tcp://172.20.0.1:443", "METRIC_SERVICE_PORT=tcp://172.20.75.223:80", "PLUGIN_SERVICE_PORT_80_TCP=tcp://172.20.37.203:80", "ORGANIZATION_SERVICE_SERVICE_PORT=80", "MULTI_CLUSTER_SERVICE_PORT_80_TCP_PROTO=tcp", "KUBERNETES_SERVICE_PORT=443", "USER_SERVICE_SERVICE_PORT=80", "INSTANCE_INFO_SERVICE_SERVICE_HOST=172.20.17.141", "PLUGIN_SERVICE_PORT_80_TCP_ADDR=172.20.37.203", "SECURITY_ISSUES_SERVICE_SERVICE_HOST=172.20.112.31", "MULTI_CLUSTER_SERVICE_PORT=tcp://172.20.4.179:80", "MONITORING_SERVICE_PORT_80_TCP_PROTO=tcp", "USER_SERVICE_PORT_80_TCP_ADDR=172.20.238.163", "INSTANCE_INFO_SERVICE_SERVICE_PORT_INSTANCE_INFO_SERVICE=80", "SUBSCRIPTION_SERVICE_SERVICE_HOST=172.20.32.181", "MULTI_CLUSTER_SERVICE_PORT_80_TCP_ADDR=172.20.4.179", "MONITORING_SERVICE_PORT_80_TCP=tcp://172.20.94.195:80", "METRIC_SERVICE_SERVICE_PORT=80", "INSTANCE_INFO_SERVICE_PORT_80_TCP_PORT=80", "FEATURE_SERVICE_PORT_80_TCP_PROTO=tcp", "PLATFORM_WEBAPP_SERVICE_PORT=80", "TOKEN_SERVICE_PORT_80_TCP=tcp://172.20.180.224:80", "MULTI_CLUSTER_SERVICE_PORT_80_TCP=tcp://172.20.4.179:80", "KUBERNETES_PORT_443_TCP_PORT=443", "THANOS_COMPACTOR_PORT_10902_TCP_PROTO=tcp", "METRIC_SERVICE_PORT_80_TCP=tcp://172.20.75.223:80", "ORGANIZATION_SERVICE_PORT_80_TCP=tcp://172.20.250.189:80", "TOKEN_SERVICE_SERVICE_HOST=172.20.180.224", "MONITORING_SERVICE_SERVICE_PORT_MONITORING_SERVICE=80", "FEATURE_SERVICE_PORT_80_TCP=tcp://172.20.236.87:80", "INSTANCE_INFO_SERVICE_PORT_80_TCP_PROTO=tcp", "FEATURE_SERVICE_PORT_80_TCP_ADDR=172.20.236.87", "THANOS_COMPACTOR_PORT=tcp://172.20.133.173:10902", "USER_SERVICE_SERVICE_HOST=172.20.238.163", "ORGANIZATION_SERVICE_SERVICE_HOST=172.20.250.189", "TOKEN_SERVICE_SERVICE_PORT_TOKEN_SERVICE=80", "MULTI_CLUSTER_SERVICE_SERVICE_PORT=80", "MONITORING_SERVICE_PORT=tcp://172.20.94.195:80", "NOTIFICATION_SERVICE_PORT_80_TCP_PROTO=tcp", "MULTI_CLUSTER_SERVICE_SERVICE_HOST=172.20.4.179", "USER_SERVICE_PORT_80_TCP_PROTO=tcp", "PLATFORM_WEBAPP_PORT=tcp://172.20.6.189:80", "ORGANIZATION_SERVICE_PORT_80_TCP_PORT=80", "SECURITY_ISSUES_SERVICE_PORT_80_TCP=tcp://172.20.112.31:80", "NOTIFICATION_SERVICE_PORT=tcp://172.20.246.182:80", "KUBERNETES_PORT_443_TCP_PROTO=tcp", "FEATURE_SERVICE_SERVICE_PORT_FEATURE_SERVICE=80", "USER_SERVICE_PORT_80_TCP=tcp://172.20.238.163:80", "SUBSCRIPTION_SERVICE_PORT_80_TCP=tcp://172.20.32.181:80", "PLATFORM_WEBAPP_PORT_80_TCP_PORT=80", "TOKEN_SERVICE_PORT_80_TCP_PORT=80", "NOTIFICATION_SERVICE_PORT_80_TCP=tcp://172.20.246.182:80", "SUBSCRIPTION_SERVICE_PORT_80_TCP_ADDR=172.20.32.181", "NOTIFICATION_SERVICE_SERVICE_PORT=80", "MONITORING_SERVICE_SERVICE_HOST=172.20.94.195", "USER_SERVICE_SERVICE_PORT_USER_SERVICE=80", "THANOS_COMPACTOR_PORT_10902_TCP=tcp://172.20.133.173:10902", "INSTANCE_INFO_SERVICE_PORT_80_TCP_ADDR=172.20.17.141", "FEATURE_SERVICE_PORT=tcp://172.20.236.87:80", "PLUGIN_SERVICE_SERVICE_HOST=172.20.37.203", "NOTIFICATION_SERVICE_PORT_80_TCP_PORT=80", "MONITORING_SERVICE_SERVICE_PORT=80", "METRIC_SERVICE_PORT_80_TCP_PROTO=tcp", "THANOS_COMPACTOR_SERVICE_PORT=10902", "INSTANCE_INFO_SERVICE_PORT_80_TCP=tcp://172.20.17.141:80", "PLATFORM_WEBAPP_PORT_80_TCP_PROTO=tcp", "ORGANIZATION_SERVICE_SERVICE_PORT_ORGANIZATION_SERVICE=80", "TOKEN_SERVICE_PORT=tcp://172.20.180.224:80", "MULTI_CLUSTER_SERVICE_PORT_80_TCP_PORT=80", "PLATFORM_WEBAPP_SERVICE_PORT_PLATFORM_WEBAPP=80", "INSTANCE_INFO_SERVICE_PORT=tcp://172.20.17.141:80", "PLATFORM_WEBAPP_SERVICE_HOST=172.20.6.189", "USER_SERVICE_PORT_80_TCP_PORT=80", "FEATURE_SERVICE_SERVICE_HOST=172.20.236.87", "NOTIFICATION_SERVICE_SERVICE_PORT_NOTIFICATION_SERVICE=80", "NOTIFICATION_SERVICE_PORT_80_TCP_ADDR=172.20.246.182", "METRIC_SERVICE_PORT_80_TCP_ADDR=172.20.75.223", "PLUGIN_SERVICE_SERVICE_PORT=80", "PLUGIN_SERVICE_SERVICE_PORT_PLUGIN_SERVICE=80", "TOKEN_SERVICE_PORT_80_TCP_ADDR=172.20.180.224", "METRIC_SERVICE_SERVICE_PORT_METRIC_SERVICE=80", "SECURITY_ISSUES_SERVICE_SERVICE_PORT_SECURITY_ISSUES_SERVICE=80", "SECURITY_ISSUES_SERVICE_PORT_80_TCP_PORT=80", "NOTIFICATION_SERVICE_SERVICE_HOST=172.20.246.182", "METRIC_SERVICE_PORT_80_TCP_PORT=80", "HOME=/root"})`)

	body := safeIssueBody(err)

	expected := "The plugin was not imported into Traefik Pilot.\n\nCause:\n```\nfailed to run the plugin with Yaegi: failed to create a new plugin instance: failed to open database: open /root/go/src/github.com/nscuro/traefik-plugin-geoblock/IP2LOCATION-LITE-DB1.IPV6.BIN: no such file or directory (cwd: /, gopath: /root/go, env: []string{\"PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin\", \"HOSTNAME=piceus-job-1634142000-hltrs\", \"PICEUS_PRIVATE_MODE=true\", \"xxx=xxx\", \"xxx=xxx\", \"TRACING_PROBABILITY=0\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=443\", \"xxx=10902\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=443\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=443\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=10902\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"xxx=xxx\", \"HOME=/root\"})\n```\nTraefik Plugin Analyzer will restart when you will close this issue.\n\nIf you believe there is a problem with the Analyzer or this issue is the result of a false positive, please contact [us](https://community.containo.us/).\n"
