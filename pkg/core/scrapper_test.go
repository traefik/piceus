...
func Test_safeIssueBody(t *testing.T) {
	...
	t.Setenv("PILOT_PLUGIN_URL", "http://plugin-service.pilot.svc.cluster.local/internal/")
	t.Setenv("PILOT_SERVICES_ACCESS_TOKEN", "7138b22877a8e9f9caf95528dbe82ff25fb2e836ce459a2b99b53f2aa336aca9")
